...
class InsumosController extends Controller
{
    ...
    {
        $producto= Producto::where('estado',1)->where('tipo','2')->get();
        return view('insumos.index',['producto'=>$producto]);
    }
    ...
    public function create()
    {
        ...
        return view('insumos.create',['tipo'=>$tipo]);
    }
    ...
    public function store(Request $request)
    {
         ...
         return redirect()->route('insumos')->withStatus(__('Producto Creado.'));
    }
    ...
    public function show($id)
    {
        ...
        return view('insumos.edit',['proveedor'=>$proveedor]);
    }
    ...
    public function edit($id)
    {
        ...
        return view('insumos.edit',['producto'=>$producto,'tipo'=>$tipo]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('insumos')->withStatus(__('Proveedor Actualizada.'));
    }
    ...
    public function codigo_barras($id){
        $user= Producto::where('codigo',$id)->first();
        if($user!=null && $user!='[]'){
            echo '<img src="data:image/png;base64,' . DNS1D::getBarcodePNG($user->codigo, 'C39+',3,33,array(1,1,1), true) . '" alt="barcode"   />';
        }else{
            return 'error 515';
        }
    }
