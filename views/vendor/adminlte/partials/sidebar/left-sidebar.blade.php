    ...
    <div class="sidebar text-sm">
        <nav class="mt-2">
            ...
            <ul class="nav nav-pills nav-sidebar flex-column {{config('adminlte.classes_sidebar_nav', '')}} nav-flat nav-child-indent"
                ...
                <li  class="nav-item has-treeview @if(strrpos($sidebar, 'caja')) menu-open @elseif(strrpos($sidebar, 'cliente')) menu-open  @elseif(strrpos($sidebar, 'proveedor')) menu-open   @elseif(strrpos($sidebar, 'empleados')) menu-open  @elseif(strrpos($sidebar, '/tipo')) menu-open @endif"">
                        ...
                        <ul class="nav nav-treeview ">
                                <li  class="nav-item  ">
                                        <a class="nav-link @if(strrpos($sidebar, '/caja')) active @endif" href="{{url('/caja')}}">
                        ...
                        <ul class="nav nav-treeview">
                                <li  class="nav-item ">
                                        <a class="nav-link @if(strrpos($sidebar, 'cliente')) active @endif" href="{{route('cliente')}}">
                                           <i class="nav-icon fas fa-fw fa-user "></i>
                        ...
                        <ul class="nav nav-treeview">
                                <li  class="nav-item ">
                                        <a class="nav-link @if(strrpos($sidebar, 'proveedor')) active @endif" href="{{route('proveedor')}}">
                                          <i class=" nav-icon fas fa-fw fa-user "></i>
                        ...
                        <ul class="nav nav-treeview">
                                <li  class="nav-item  ">
                                        <a class="nav-link @if(strrpos($sidebar, 'empleados')) active @endif" href="{{route('empleados')}}">
                                            <i class="nav-icon fas fa-fw fa-user "></i>
                        ...
                        <ul class="nav nav-treeview">
                                <li  class="nav-item ">
                                        <a class="nav-link @if(strrpos($sidebar, '/tipo')) active @endif" href="{{route('tipo_producto')}}">
