<nav class="main-header navbar
    ...
    <ul class="navbar-nav">
        ...
        <b>Manejo de Caja</b>
        @if($sessiondata==null || $sessiondata==0)
        <button id="botoncaja" class="btn btn-xs col-md-1 col-xs-1" onclick="abrircaja({{$sessiondata}})"> <i class="fas fa-toggle-off"></i></button>
        @else
        <button id="botoncaja" class="btn btn-xs col-md-1 col-xs-1" onclick="abrircaja({{$sessiondata}})"><i class="fas fa-toggle-on"></i></button>
        @endif
    {{-- Navbar right links --}}
