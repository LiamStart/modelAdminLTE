            ...
            <div class="card">
                <div class="card-header bg-white border-0">
                        <div class="row align-items-center">
                            <h3 class="col-12 mb-0">{{ __('Agregar Producto') }}</h3>
                        </div>
                </div>
                <div class="card-body">
                    <form method="post" action="{{ route('producto.store') }}" autocomplete="off" id="formulario">
                        @csrf
                        @if (session('status'))
                        ...
                        <div class="form-group{{ $errors->has('codigo') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="codigo" id="codigo" class="form-control form-control-alternative{{ $errors->has('ci') ? ' is-invalid' : '' }}" placeholder="{{ __('Código') }}"  required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('precio') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text"  id="precio" name="precio" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" class="form-control form-control-alternative{{ $errors->has('phone_number') ? ' is-invalid' : '' }}" placeholder="{{ __('Precio Compra') }}"  required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('precio_v') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text"  id="precio_v" name="precio_v" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" class="form-control form-control-alternative{{ $errors->has('phone_number') ? ' is-invalid' : '' }}" placeholder="{{ __('Precio Venta') }}"  required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('cantidad') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="number" name="cantidad"  id="cantidad" class="form-control form-control-alternative{{ $errors->has('f_nacimiento') ? ' is-invalid' : '' }}"  autofocus>
                        ...
                        <div class="form-group{{ $errors->has('stock_minimo') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="number" name="stock_minimo"  id="stock_minimo" class="form-control form-control-alternative{{ $errors->has('f_nacimiento') ? ' is-invalid' : '' }}"  autofocus>
