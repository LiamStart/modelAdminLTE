            ...
            <div class="card">
                <div class="card-header bg-white border-0">
                        <div class="row align-items-center">
                            <h3 class="col-12 mb-0">{{ __('Agregar Proveedor') }}</h3>
                        </div>
                </div>
                <div class="card-body">
                    <form method="post" action="{{ route('proveedor.store') }}" autocomplete="off" id="formulario">
                        @csrf
                        @if (session('status'))
                        ...
                        <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                    <label class="form-control-label" for="cedula">{{ __('Cédula Proveedor:') }}</label>
                                    <input type="text" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;" name="cedula" id="cedula" class="form-control form-control-alternative{{ $errors->has('ci') ? ' is-invalid' : '' }}" maxlength="13" placeholder="{{ __('Ci') }}"  required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                            <label class="form-control-label" for="input-name">{{ __('Nombre Proveedor:') }}</label>
                        ...
                        <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                    <label class="form-control-label" for="cedula">{{ __('Dirección de Proveedor:') }}</label>
                        ...
                        <div class="form-group{{ $errors->has('telefono') ? ' has-danger' : '' }}">
                                    <label class="form-control-label" for="telefono">{{ __('Telefono de Proveedor:') }}</label>
