...
<script type="text/javascript">
    ...
    function agregarArticulo(articulo) {
        ...
        if (validacion) { // si ya esta agregado advierto
            ...
            var total_precio = '<input type="text" name="precio' + contador + '" id="precio' + contador + '" value="' + articulo.precio + '" onchange="suma_totales()" readonly> <button type="button" class="btn-danger btn-xs" onclick="editar_precio('+contador+')"><i class="fas fa-pen-square"></i></button>';
    ...
    function editar_precio(id){
        ...
        $('#precio'+id).val(precio.toFixed(2,2));
        if ( $('#precio'+id).is('[readonly]') ) { 
            $('#precio'+id).prop("readonly",false);
        }else{
            $('#precio'+id).prop('readonly', true);
        }
