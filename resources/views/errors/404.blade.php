...
<body class="permission_denied">
  ...
  <div class="denied__wrapper">
    <h1>404</h1>
    <h3>Perdido en el <span>Espacio </span> SISTEMA ? Hmm, parece que ésta página no existe.</h3>
    ...
    <a href="{{url('/dashboard')}}"><button class="denied__link">Ir al inicio</button></a>
  </div>
<script>
  var particles = {
      "particles": {
